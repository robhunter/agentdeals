...
const GUIDE_ENTRIES: Array<{ slug: string; title: string; description: string }> = [
  ...
  { slug: "ci-cd-pricing", title: "CI/CD Tools Pricing Comparison 2026", description: "The definitive comparison of 17+ CI/CD tools — build minutes, runners, parallelism, pricing models, and hidden costs across general, cloud-native, mobile, and self-hosted categories" },
  { slug: "database-pricing", title: "Database Pricing Comparison 2026", description: "The definitive comparison of 25+ database services — managed Postgres, serverless/edge, document/NoSQL, cloud provider, and specialized categories with free tier analysis and cost breakdowns" },
  { slug: "vector-database-pricing", title: "Vector Database Pricing Comparison 2026", description: "The definitive comparison of 11 vector databases — Pinecone, Qdrant, Weaviate, Chroma, Zilliz, LanceDB, pgvector. Free tiers, storage limits, dimensions, self-hosted vs managed costs for RAG/AI" },
  { slug: "llm-api-pricing", title: "LLM API Free Tiers & Free Credits 2026", description: "Which LLM APIs have a genuinely free tier or free credits, and which only sell tokens — frontier labs, inference providers and open-source hosts compared, with per-token pricing and hidden costs" },
  ...
  { slug: "monitoring-comparison-2026", title: "Free Tiers for Error Tracking, Monitoring & Observability 2026", description: "25+ error tracking, monitoring and observability services — Datadog, Grafana Cloud, New Relic, Better Stack, Sentry, Checkly, SigNoz, HyperDX — free data ingest, retention, APM, scaling costs at 10/50/100/500 hosts" },
  { slug: "email-comparison-2026", title: "Email & Transactional Messaging Comparison 2026", description: "20+ email services — SendGrid exodus migration, transactional vs marketing, growth cost at 10K-1M emails/month, deliverability traps" },
  { slug: "storage-comparison-2026", title: "Storage & CDN Comparison 2026", description: "15+ storage and CDN services — S3 vs R2 vs B2, egress tax breakdown, zero-egress providers, media CDN, self-hosted options, scaling costs at 100GB/1TB/10TB/100TB" },
  ...
  { slug: "state-of-free-tiers", title: "State of Developer Free Tiers", description: "Data-driven report: 77 pricing changes tracked, monthly trend visualization, category erosion analysis, stable vendors — the authoritative source on free tier trends" },
  ...
  { slug: "developers", title: "REST API Developer Hub", description: "REST API landing page — 18 endpoints, quick start examples in curl/Python/JavaScript, endpoint reference, use cases, no auth required" },
