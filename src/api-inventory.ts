...
export const API_ENDPOINTS: readonly ApiEndpoint[] = [
  ...
  { method: "GET", path: "/api/changes", desc: "Pricing and deal changes", params: "since, type, vendor, vendors, category, categories, limit, offset, include_retracted, include_index_housekeeping", group: "product", request: "/api/changes?since=2025-01-01", cites: true },
