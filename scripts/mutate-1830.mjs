...
const MUTANTS = [
  ...
  [
    "src/serve.ts",
    "s!freeCell: statesNoFreeTier\\(vendor.free\\)!freeCell: false!",
    "the estimator prices every row at nothing at zero users",
  ],
  [
    "src/serve.ts",
    's!line-through">PlanetScale</span> <span class="removed-badge">FREE REMOVED!line-through">PlanetScale</span> <span class="removed-badge">REMOVED!',
  ...
  [
    "test/hardcoded-row-agrees-with-the-record.test.ts",
    "s!exemption => exemption.page === page && exemption.vendor === vendor && claim.includes\\(exemption.claim\\),!() => true,!",
