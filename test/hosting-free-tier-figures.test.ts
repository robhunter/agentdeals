...
const RETIRED_FIGURES: Retired[] = [
  ...
  },
  {
    ...
    pattern: /Gemini Code Assist's unlimited free tier|wildcard: Gemini Code Assist[^.]*\bfree\b|Gemini Code Assist \(\$0\)|Free individual \+ Enterprise/i,
    replacedBy: /Ended 2026-06-18/,
    vendorRecord: () => recordFor("Google Gemini Code Assist", "IDE & Code Editors").description,
  },
  {
    what: "Gemini Code Assist listed among Google Cloud's free AI coding options",
    pattern: /Gemini Code Assist is a strong free-tier|all free for individual developers|Free individual tier: code completions/i,
    replacedBy: /stopped serving requests/,
    vendorRecord: () => recordFor("Google Gemini Code Assist", "IDE & Code Editors").description,
  },
  {
    what: "Gemini Code Assist Standard's annual-commitment price given as its monthly price",
    pattern: /Gemini Code Assist(?: Ended)? Ended 2026-06-18 — — \$19\/seat|Gemini Code Assist \$19 \$95|Enterprise tier \(\$19\/seat\)/,
    replacedBy: /Gemini Code Assist(?: Ended)? Ended 2026-06-18 — — \$22\.80\/seat|Gemini Code Assist \$22\.80 \$114 \$19\/user\/month with an annual commitment/,
    vendorRecord: () => recordFor("Google Gemini Code Assist", "IDE & Code Editors").description,
  },
  {
    what: "Gemini Code Assist's free-tier launch presented as a current expansion",
    pattern: /Gemini Code Assist free tier for individual developers|Gemini Code Assist launched a free tier/i,
    replacedBy: /Ended 2026-06-18/,
    vendorRecord: () => recordFor("Google Gemini Code Assist", "IDE & Code Editors").description,
  },
  {
