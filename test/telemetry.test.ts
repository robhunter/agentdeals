...
describe("telemetry persistence", () => {
  ...
  it("loads seed data and accumulates across simulated restart", async () => {
    ...
    assert.ok(stats0.last_deploy_at);
    assert.strictEqual(stats0.total_sessions, 0);
    ...
    assert.strictEqual(stats1.cumulative_sessions, 97);
    assert.strictEqual(stats1.total_tool_calls, 3);
    assert.strictEqual(stats1.cumulative_tool_calls, 415);
    assert.strictEqual(stats1.total_api_hits, 1);
    assert.strictEqual(stats1.cumulative_api_hits, 204);
    assert.strictEqual(stats1.landing_page_views, 1);
    assert.strictEqual(stats1.cumulative_landing_views, 88);
