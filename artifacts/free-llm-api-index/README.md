...
We re-read records on a rolling schedule. 0 rows say in the row that we have not re-read them within our 94-day interval. That is a statement about us, not about the vendor. Where a link has stopped resolving, the row says that instead, because we cannot re-read a page that does not answer.
